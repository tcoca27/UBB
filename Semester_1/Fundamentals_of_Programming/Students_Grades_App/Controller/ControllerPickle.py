from TextFileRepos.DiscplineRepoBinary import DisciplinesList
from TextFileRepos.StudentRepoBinary import StudentList
from TextFileRepos.GradeRepoBinary import GradeList
...
class Controller:
    ...
    def showS(self):
        return self._StudentsList.printList()

    def showD(self):
        return self._DisciplineList.printList()

    def showG(self):
        return self._GradeList.printList()
