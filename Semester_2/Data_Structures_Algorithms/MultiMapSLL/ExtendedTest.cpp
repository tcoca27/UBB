...
void testRange(Relation r){
    SortedMultiMap smm=SortedMultiMap(r);
    populateSMMEmpty(smm, 10, 20);
    assert(smm.getKeyRange()==10);
}

void testAllExtended() {
    testCreate();
    std::cout<<"Create test successful\n";
    testSearch();
    std::cout<<"Search test successful\n";
    testRemove();
    std::cout<<"Remove test successful\n";
    testIterator();
    std::cout<<"Iterator test successful\n";
    testRange(asc);
